...
- Проектирую backend-архитектуры: DDD, event-driven, State Machine, Outbox/Inbox, CQRS
- Работаю с Go в продакшне: парсеры, внутренние пакеты, микросервисы
- Строю интеграции с внешними системами через очереди и gRPC
- Использую AI-инструменты для анализа кода, ревью и проработки архитектуры
